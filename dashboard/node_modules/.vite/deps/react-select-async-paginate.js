import {
  ...
  index,
  useStateManager
} from "./chunk-7HYEVNFW.js";
import {
  _extends
} from "./chunk-MFBGX6CZ.js";
import "./chunk-JH7Y3LKN.js";
import "./chunk-MHMSJ6BD.js";
import {
  require_react_dom
...
var useLazyRef = (init) => {
  const resultRef = (0, import_react3.useRef)(EMPTY_VALUE);
...
function useIsMountedRef() {
  var isMountedRef = (0, import_react4.useRef)(false);
...
var useLatest = function useLatest2(value) {
  var ref = import_react5.default.useRef(value);
  index(function() {
    ref.current = value;
  });
  return ref;
...
var useAsyncPaginateBase = (params, deps = []) => {
  ...
  const isInitRef = (0, import_react7.useRef)(true);
  const paramsRef = (0, import_react7.useRef)(params);
  paramsRef.current = params;
  const [_stateId, setStateId] = (0, import_react7.useState)(0);
  ...
  const handleScrolledToBottom = (0, import_react7.useCallback)(() => {
    const currentInputValue = paramsRef.current.inputValue;
...
var useAsyncPaginate = (params, deps = []) => {
  ...
  const [inputValueState, setInputValue] = (0, import_react6.useState)(
    defaultInputValueParam || ""
  );
  const [menuIsOpenState, setMenuIsOpen] = (0, import_react6.useState)(!!defaultMenuIsOpenParam);
  ...
  const onInputChange = (0, import_react6.useCallback)(
  ...
  const onMenuClose = (0, import_react6.useCallback)(() => {
    if (onMenuCloseParam) {
      onMenuCloseParam();
    }
    setMenuIsOpen(false);
  }, [onMenuCloseParam]);
  const onMenuOpen = (0, import_react6.useCallback)(() => {
    if (onMenuOpenParam) {
      onMenuOpenParam();
    }
    setMenuIsOpen(true);
...
function wrapMenuList(MenuList2) {
  function WrappedMenuList(props) {
    ...
    const checkTimeoutRef = (0, import_react9.useRef)(null);
    const menuListRef = (0, import_react9.useRef)(null);
    const shouldHandle = (0, import_react9.useCallback)(() => {
    ...
    const checkAndHandle = (0, import_react9.useCallback)(() => {
      if (shouldHandle()) {
    ...
    const setCheckAndHandleTimeout = (0, import_react9.useMemo)(() => {
      const res = () => {
        checkAndHandle();
...
var useComponents = (components2) => (0, import_react8.useMemo)(
  () => ({
    MenuList,
    ...components2
  }),
